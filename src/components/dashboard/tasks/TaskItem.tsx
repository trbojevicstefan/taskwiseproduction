...
import { Bot, ChevronDown, ChevronRight, MoreVertical, Loader2, Brain, Zap as SimplifyIcon, Edit3, Trash2, UserPlus, LayoutGrid } from 'lucide-react';
            ...
            <div className="flex items-center gap-2 opacity-0 group-hover/task-item:opacity-100 transition-opacity">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuSeparator />
                    <DropdownMenuItem onClick={() => onDeleteTask(task.id)} disabled={isProcessing} className="text-destructive focus:text-destructive"><Trash2 className="mr-2 h-4 w-4" />Delete Task</DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
            </div>
        </div>
